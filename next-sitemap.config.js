...
module.exports = {
  siteUrl: process.env.SITE_URL || "http://localhost:3000/", // .게시하는 site의 url
  // siteUrl: "https://ssog.pages.dev", // .게시하는 site의 url
  ...
  robotsTxtOptions: {
    ...
    additionalSitemaps: [
      "http://loaclhost:3000/server-sitemap-index.xml", // <==== Add here
    ],
  }, // robots.txt 옵션 설정
};
