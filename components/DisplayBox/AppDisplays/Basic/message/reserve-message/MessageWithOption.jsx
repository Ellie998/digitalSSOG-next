    ...
    <>
      <section className={classes.layout}>
        ...
        <div className={classes.appMain}>
          ...
          {/* option messages */}
          {isSubmitted && functionName === functionName_reserveMessage && (
          ...
          {isSubmitted && functionName === functionName_sendImg && (
          ...
          {isSubmitted && functionName === functionName_sendAudio && (
            <div>
              <div className={classes["appMain_sendMessageWrap"]}>
                <div
          ...
          {isSubmitted && functionName === functionName_sendPhoneNum && (
            <div>
              <div className={classes["appMain_sendMessageWrap"]}>
                <div
                  className={`${classes["appMain_sendMessageOptionWrap--flex"]}`}>
